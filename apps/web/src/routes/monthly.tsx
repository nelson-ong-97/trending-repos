...
export const Route = createFileRoute("/monthly")({
	...
	head: () => {
		const title = "Monthly Trending GitHub Repositories";
		const description = "Discover the most popular GitHub repositories trending this month. Find the hottest open-source projects updated in the last 30 days.";
		const canonical = `${SITE_URL}/monthly`;
	...
	return (
		<main className="container mx-auto px-4 py-8">
			<section className="mb-8">
				<h1 className="text-3xl font-bold mb-2">Monthly Trending Repositories</h1>
				<p className="text-muted-foreground">
					Discover the most popular GitHub repositories trending this month
				</p>
			</section>
